...
const AssessmentCompletePage: React.FC = () => {
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center items-center p-4 text-center">
            <div className="w-full max-w-lg bg-white dark:bg-slate-800 p-10 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 space-y-4">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-500 pt-4">You may now close this window.</p>
            </div>
        </div>
    );
};
